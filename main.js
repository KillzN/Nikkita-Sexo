...
import Pino from 'pino'
import { NikkitaJadiBot } from './plugins/jadibot-serbot.js'
...
global.authFile = 'NikkitaSession'
...
NikkitaJadiBot({pathNikkitaJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
