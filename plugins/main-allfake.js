...
handler.all = async function (m) {
  ...
  global.asistencia = 'Wa.me/51947248937'
  ...
  let instagram = 'https://www.instagram.com/nikki30.ff'
  ...
  */
  ...
  global.packN = `Pᴏʀɴʜᴜʙ: @BʏNikkita\n\n☁ 𝖲𝖾𝗇𝖽𝗂𝗇𝗀 𝖻𝗒 𝖡𝗈𝗍:\n↳ @${usnamebot}\n🌺 𝖴𝗌𝗎𝖺𝗋𝗂𝗈:`;
  global.authN = `\n↳ @${usname}`;
  ...
  global.canalNombreM = ["Pᴏʀɴʜᴜʙ: @BʏNikkita", "Pᴏʀɴʜᴜʙ: @BʏNikkita", "Pᴏʀɴʜᴜʙ: @BʏNikkita"]
  global.channelRD = await getRandomChannel()

  global.icono = [
    "https://files.catbox.moe/aulvc6.jpg",
    "https://files.catbox.moe/aulvc6.jpg",
    "https://files.catbox.moe/aulvc6.jpg",
    "https://files.catbox.moe/aulvc6.jpg",
    "https://files.catbox.moe/aulvc6.jpg",
